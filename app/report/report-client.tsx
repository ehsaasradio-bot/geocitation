...
export function ReportClient() {
  ...
  const exportMarkdown = () => {
    const lines = [
      `# AI SIGNAL report: ${result.domain}`,
      "",
      ...
      "## Executive brief",
      "",
      `AI SIGNAL found ${issues.length} priority issues and ${strengths.length} verified strengths across crawler access, entity confidence, extractability, structured data, trust and machine-readable guidance.`,
      "",
      "## Priority fixes",
      "",
