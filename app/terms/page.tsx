...
export const metadata: Metadata = {
  title: "Terms of Service — GEOCITATION",
  description: "Terms for using GEOCITATION audits, reports and GEO implementation services.",
};
  ...
  return (
    ...
    >
      <div className="policy-stack">
        <article><span>01</span><h2>Authorized use</h2><p>Only submit websites you own, operate or have permission to evaluate. Do not use GEOCITATION to probe systems you are not allowed to assess.</p></article>
        ...
        <article><span>06</span><h2>Manual model observations</h2><p>Visibility Lab results are user-recorded observations unless a provider is explicitly marked as connected. You are responsible for accurately recording model outputs and respecting each provider’s terms. GEOCITATION does not represent manual entries as independently verified.</p></article>
      </div>
    </InfoPage>
  );
}
