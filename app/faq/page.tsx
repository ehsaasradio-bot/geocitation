...
export const metadata: Metadata = {
  title: "FAQ — GEOCITATION",
  description: "Answers about AI visibility, GEO audits, crawler access, citations, pricing and implementation.",
};

const faqs = [
  ["What does GEOCITATION test?", "GEOCITATION checks whether AI systems can discover, understand, trust and cite your website. It looks at crawl access, structured data, extractable passages, entity clarity and trust signals."],
  ["Is this the same as SEO?", "Not exactly. SEO focuses on ranking in search results. GEOCITATION focuses on whether answer engines can read your site, reason about it and confidently mention it in generated answers."],
  ...
  ["Do you guarantee AI citations?", "No honest audit can guarantee citations. GEOCITATION shows the barriers and opportunities that influence whether AI systems can confidently use your content."],
