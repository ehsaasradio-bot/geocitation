...
export const metadata: Metadata = {
  title: "Privacy Policy — GEOCITATION",
  description: "GEOCITATION privacy policy for website audits, submitted URLs and contact information.",
};
...
export default function PrivacyPage() {
  return (
    <InfoPage
      ...
      intro="A plain-language policy for how GEOCITATION handles submitted websites, audit activity and private saved reports."
    >
      <div className="policy-stack">
        <article><span>01</span><h2>Information processed</h2><p>When you run an audit, GEOCITATION processes the website URL you submit and public content fetched from that website. Do not submit private credentials or non-public network addresses.</p></article>
        ...
        <article><span>06</span><h2>Infrastructure and abuse prevention</h2><p>The hosting platform may process limited security and operational logs. GEOCITATION uses salted one-way identifiers with short expiration windows to enforce audit limits without storing raw network addresses in its rate-limit table.</p></article>
        ...
        <article><span>08</span><h2>Visibility lab observations</h2><p>If you use the premium visibility lab, GEOCITATION stores the platform, generated test prompt, outcome you select, and optional notes or source URL. These are manual observations you provide and are removed when you delete the associated saved report.</p></article>
        <article><span>09</span><h2>Automated provider runs</h2><p>When a provider credential is connected, GEOCITATION may send the selected public test prompt and audited domain to that provider. Returned answer text, model name, source citations and whether the target was cited are stored with your report. Provider terms and data controls also apply.</p></article>
